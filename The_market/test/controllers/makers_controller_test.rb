...
class MakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maker" do
    assert_difference('Maker.count') do
      post makers_url, params: { maker: {  name: @maker. name, id: @maker.id, image_url: @maker.image_url } }
    end
  ...
  test "should update maker" do
    patch maker_url(@maker), params: { maker: {  name: @maker. name, id: @maker.id, image_url: @maker.image_url } }
